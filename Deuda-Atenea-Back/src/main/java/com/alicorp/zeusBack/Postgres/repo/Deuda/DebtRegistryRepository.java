...
@Repository
public interface DebtRegistryRepository extends JpaRepository<DebtRegistry, String>, JpaSpecificationExecutor<DebtRegistry> {
    ...
    @Query("SELECT DISTINCT d FROM DebtRegistry d " +
            ...
            "LEFT JOIN d.productName pn " +
            "LEFT JOIN d.currency cur " +
            "LEFT JOIN d.periods per " +
            "LEFT JOIN d.rateClassification rcl " +
            "LEFT JOIN d.rateType rt " +
            "LEFT JOIN d.amortizationMethod am " +
            "LEFT JOIN d.schedules sch " +
            "WHERE " +
            "(:searchText IS NULL OR :searchText = '' OR " +
            "    LOWER(d.id) LIKE LOWER(CONCAT('%', :searchText, '%')) OR " +
            "    LOWER(STR(d.productClassId)) LIKE LOWER(CONCAT('%', :searchText, '%')) OR " +
            "    LOWER(STR(d.productTypeId)) LIKE LOWER(CONCAT('%', :searchText, '%')) OR " +
            "    LOWER(pn.description) LIKE LOWER(CONCAT('%', :searchText, '%')) OR " +
            ...
            "    LOWER(per.t450Description) LIKE LOWER(CONCAT('%', :searchText, '%')) OR " +
            "    LOWER(rt.t449Description) LIKE LOWER(CONCAT('%', :searchText, '%')) OR " +
            "    LOWER(rcl.t506Description) LIKE LOWER(CONCAT('%', :searchText, '%')) OR " +
            "    LOWER(d.referenceRate) LIKE LOWER(CONCAT('%', :searchText, '%')) OR " +
            "    LOWER(STR(d.fixedRatePercentage)) LIKE LOWER(CONCAT('%', :searchText, '%')) OR " +
            "    LOWER(STR(d.rateAdjustment)) LIKE LOWER(CONCAT('%', :searchText, '%')) OR " +
            "    LOWER(STR(d.applicableMargin)) LIKE LOWER(CONCAT('%', :searchText, '%')) OR " +
            "    LOWER(STR(d.nominal)) LIKE LOWER(CONCAT('%', :searchText, '%')) OR " +
            "    LOWER(STR(sch.amortization)) LIKE LOWER(CONCAT('%', :searchText, '%')) OR " +
            "    LOWER(STR(sch.interest)) LIKE LOWER(CONCAT('%', :searchText, '%')) OR " +
            "    LOWER(STR(sch.installment)) LIKE LOWER(CONCAT('%', :searchText, '%')) OR " +
            "    LOWER(STR(sch.appliedRate)) LIKE LOWER(CONCAT('%', :searchText, '%')) OR " +
            "    LOWER(STR(sch.interestRate)) LIKE LOWER(CONCAT('%', :searchText, '%')) OR " +
            ...
            "     LOWER(STR(d.productClassId)) LIKE LOWER(CONCAT('%', :productClassId, '%'))) " +
            "AND (:productTypeId IS NULL OR :productTypeId = '' OR " +
            "     LOWER(STR(d.productTypeId)) LIKE LOWER(CONCAT('%', :productTypeId, '%'))) " +
            ...
            "AND (:productNameId IS NULL OR d.productNameId = :productNameId) " +
            ...
            "AND (:rateAdjustmentMin IS NULL OR d.rateAdjustment >= :rateAdjustmentMin) " +
            ...
            "AND (CAST(:registrationDateTo AS timestamp) IS NULL OR d.registrationDate <= :registrationDateTo)")
    Page<DebtRegistry> searchDebts(
            ...
            @Param("rateAdjustmentMin") BigDecimal rateAdjustmentMin,
